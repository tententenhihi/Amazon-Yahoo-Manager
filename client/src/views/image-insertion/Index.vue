      ...
      <div class="px-30 py-20">
        <div class="form-row">
          <div class="col-md-10 col-12">
            <div class="row" v-for="(image, index) in this.imageInsertion.images" :key="index">
              ...
              <div class="col-7 product-image">
                ...
                <img :src="image ? image : require('@/assets/images/no_product.png')" :id="`image_${index}_preview`"
        ...
        <div class="row mt-20">
          <button class="btn btn-success mb-1 mr-1" @click="onSaveImages()">
...
export default {
  ...
  methods: {
    ...
    async onSaveImages () {
      ...
      let payload = {
        ...this.imageInsertion,
        images: this.imageInsertion.images.map(item => item.replace(this.SERVER_HOST_UPLOAD, ""))
      }
