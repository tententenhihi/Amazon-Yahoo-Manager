          ...
          <div class="col-md-9 col-12">
            <div class="row" v-for="(image, index) in images" :key="index">
              <div class="col-4 text-align-end">
                商品画像 : <br />
                <small>
                  (商品画像は10枚まで可能/画像は１０００PX
                  以下にしてください。大きすぎるとアップロードできず、エラーになります。)
                </small>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-8 product-image">
                <input
                  ...
                  accept="image/png, image/gif, image/jpeg"
                  class="ml-2 d-none"
                  :ref="'inputImage-' + images.length"
                  @change="onUploadImage(images.length)"
                />
                <img
            ...
            <transition name="fade">
              <div v-show="isShowProductInfo">
                <div class="row">
                  <div class="col-4 text-align-end">
                    <font color="red">*</font> フォルダ :
                  </div>
                  <div class="col-8">
                    <select
                      class="form-control"
                      id=""
                      v-model="product.folder_id"
                    >
                      <option
                ...
                <div class="row">
                  <div class="col-4 text-align-end">
                    <font color="red">*</font>Yahoo商品のカテゴリー :
                  </div>
                  <div class="col-8">
                    <span
                      v-if="yahooAuctionCategory"
                ...
                <div class="row">
                  <div class="col-4 text-align-end">
                    <font color="red">*</font>Yahoo商品のカテゴリー（ID指定）:
                  </div>
                  <div class="col-8">
                    <input
                      type="text"
                      class="form-control"
                      v-model.lazy="product.yahoo_auction_category_id"
                      id=""
                    />
                ...
                <div class="row">
                  ...
                  <div class="col-8 col-lg-4">
                    <input
                      type="number"
                      v-model="product.bid_or_buy_price"
                      class="form-control"
                    />
                    <p>
