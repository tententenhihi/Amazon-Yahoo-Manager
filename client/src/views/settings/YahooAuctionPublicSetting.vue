  ...
  <div v-if="isInit" class="mt-40 px-20 py-20" style="background-color: #fff">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      ...
      <li class="nav-item">
        <a
          class="nav-link"
          id="auction-delete-tab"
          data-toggle="tab"
          href="#auction-delete"
          role="tab"
          aria-controls="auction-delete"
          aria-selected="false"
          >Y!オーク 出品終了オークションの削除</a
        >
      </li>
    </ul>
    <div class="tab-content" id="myTabContent">
      ...
      >
        <div class="wrapper-content">
          ...
          <div class="box-content">
            <div
              class="form-horizontal col-10 col-lg-6 py-20"
            ...
            >
                ...
                <div class="col-9">
                  <div class="form-check mt-2">
                    <input
                      ...
                      type="checkbox"
                      v-model="setting.new_list_auto"
                    />
                  </div>
                </div>
              </div>
              <div class="form-group row">
                <label for="target-folder" class="col-3 col-form-label"
                  >対象フォルダ :</label
                >
                <div class="col-9">
                  <select
              ...
              <div class="form-group row">
                <label for="" class="col-3 col-form-label"
                  >初回出品開始時間(時) : <br /><small>(24時間表記:0~23)</small>
                </label>
                <div class="col-9">
                  <select
                    class="form-control"
                    id=""
                    v-model="setting.new_list_start_time_hour"
                  >
                    <option v-for="(n, index) in 24" :value="index" :key="n">
                      {{ index }}
                    </option>
                  </select>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-9">
                  <select
                    class="form-control"
                    id=""
                    v-model="setting.new_list_start_time_minute"
                  >
                    <option v-for="n in START_MINUTE" :value="n" :key="n">
                      {{ n }}
                    </option>
                  </select>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-8">
                  <input
                    ...
                    :min="1"
                    :maxlength="2"
                    @keyup="validatePublicInterval"
                    :max="12"
                    :value="setting.publish_interval"
                    class="form-control"
                    :readonly="!setting.new_list_auto"
                  />
                </div>
                <div class="col-1">
                  <input
                    ...
                    :value="true"
                    id=""
                    v-model="setting.new_list_interval_per_day"
                  />
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-8">
                  <select
                    class="form-control"
                    id=""
                    v-model="setting.new_list_day_of_week"
                  >
                    <option
                      v-for="(n, index) in DAY_OF_WEEK"
                      :value="n.value"
                      :key="index"
                    >
                      {{ n.display }}
              ...
              <div class="form-group row">
                ...
                <div class="col-9">
                  <select
                    class="form-control"
                    id=""
                    v-model="setting.new_list_process_of_skipped_items"
                  >
                    <option value="1">
                      以降、24時間経過した時点で出品する
                    </option>
      ...
      >
        <div class="wrapper-content">
          ...
          <div class="box-content">
            ...
            <hr />
            <div
              class="form-horizontal col-7 py-20"
              style="float: none; margin: 0 auto"
            >
              <div class="form-group row">
              ...
              <div class="form-group row">
                <label for="" class="col-3 col-form-label"
                  >再出品開始時間(時) : <br /><small>(24時間表記:0~23)</small>
                </label>
                <div class="col-9">
                  <select
                    class="form-control"
                    id=""
                    v-model="setting.relist_start_time_hour"
                  >
                    <option v-for="(n, index) in 24" :value="index" :key="n">
                      {{ index }}
                    </option>
              ...
              <div class="form-group row">
                ...
                <div class="col-9">
                  <select
                    class="form-control"
                    id=""
                    v-model="setting.relist_start_time_minute"
                  >
                    <option v-for="n in START_MINUTE" :value="n" :key="n">
                      {{ n }}
                    </option>
          ...
          <div class="box-content">
            <div class="px-20 py-20">
              <p>
                ...
                各日にフォルダを指定することで、毎日異なる商品フォルダを自動で出品することができます。
                出品しない日を設けることも可能です<br />
              </p>
            </div>
            <hr />
            <div
                ...
                <div class="col-9">
                  <div class="form-check mt-2">
                    <input
                      class="form-check-input"
                      type="checkbox"
                      v-model="setting.calendar_list_setting"
                    />
                  </div>
                </div>
              </div>
      ...
      <div
        ...
        id="auction-delete"
        role="tabpanel"
        aria-labelledby="auction-delete-tab"
      >
        <div class="wrapper-content">
          <div class="box-header py-10">
            <i class="fa fa-calendar mr-2"></i>Y!オーク
            出品終了オークションの削除
          </div>
          <hr />
          <div class="box-content">
            <div class="mx-20 py-20">
              ...
              <div class="row justify-content-center mt-20">
                <button
                  ...
                  v-if="!setting.auction_delete"
                  @click="onUpdateSetting(true)"
                >
